...
public class JAXBException  extends org.apache.axis.AxisFault  implements java.io.Serializable {
    ...
    private socialapp.soap.client.StackTraceElement[] linkedException;
    ...
    public JAXBException(
           ...
           socialapp.soap.client.StackTraceElement[] linkedException,
     ...
     */
    public socialapp.soap.client.StackTraceElement[] getLinkedException() {
        return linkedException;
    }
     ...
     */
    public void setLinkedException(socialapp.soap.client.StackTraceElement[] linkedException) {
        this.linkedException = linkedException;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://soap.socialapp/", "JAXBException"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://soap.socialapp/", "stackTraceElement"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
